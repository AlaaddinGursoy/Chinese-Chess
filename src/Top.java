public class Top extends Item{
    ...
    public String[] getAllMoves() {
        ...
        while(tmpC<9 && tmpC>=0 && flag!=2){
            ...
            if(flag==2 && b.helper[row][tmpC].color.equals(color))
                break;
        ...
        while(tmpR<=9 && tmpR>=0 && flag!=2){
            ...
            if(flag==2 && b.helper[tmpR][column].color.equals(color))
                break;
